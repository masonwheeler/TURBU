...
let V_SHOP_NUM_GREET = 'Shop%d-Greet'
let V_SHOP_NUM_CONTINUE = 'Shop%d-Continue'
let V_SHOP_NUM_BUY = 'Shop%d-Buy'
let V_SHOP_NUM_SELL = 'Shop%d-Sell'
let V_SHOP_NUM_LEAVE = 'Shop%d-Leave'
let V_SHOP_NUM_BUY_WHAT = 'Shop%d-Buy What'
let V_SHOP_NUM_HOW_MANY = 'Shop%d-Buy Quantity'
let V_SHOP_NUM_BOUGHT = 'Shop%d-Bought'
let V_SHOP_NUM_SELL_WHAT = 'Shop%d-Sell What'
let V_SHOP_NUM_SELL_QUANT = 'Shop%d-Sell Quantity'
let V_SHOP_NUM_SOLD = 'Shop%d-Sold'
